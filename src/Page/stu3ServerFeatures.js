...
export default class stu3ServerFeatures extends React.Component {
            ...
            return (
                <div>
                    <Segment size={size}>
                        ...
                        <p>This server implements the <WebLink newTab={true} url={FhirConstant.STU3_SpecWebsiteUrl} display={FhirConstant.STU3_SpecWebsiteDisplay} /> release of the FHIR specification and is built utilising the official <WebLink newTab={true} url={FhirConstant.fhirNetApiGitHubUrl} display={'.NET API for HL7 FHIR'} />.</p>
            ...
            <Grid stackable >
                ...
                <Grid.Row columns={2} only='computer'>
                    <Grid.Column width={8} verticalAlign='middle' >
                        <Header>STU3 Pyro Server Features</Header>
                    </Grid.Column>
                    <Grid.Column width={8} >
                ...
                <Grid.Row columns={2} only='mobile'>
                    <Grid.Column width={8} verticalAlign='middle' >
                        <Header>Pyro Server Features STU3</Header>
                    </Grid.Column>
                    <Grid.Column width={8} >
